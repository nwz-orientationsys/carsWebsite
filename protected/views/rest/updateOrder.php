...
?>
	...
	<?php echo $form->dropDownListRow($model,'car_id',Cars::getCustomerCars(),array('class' => 'span4')); ?>

	<?php echo $form->dropDownListRow($model,'user_id',Customer::getCustomerName(),array('class' => 'span4')); ?>
